<template>
            ...
            <div class="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
                ...
                >
                    ...
                    >
                        ...
                        <tbody class="w-full">
                            <tr
                                v-for="(room, index) in paginatedData"
                                :key="index"
                            >
                                <td
                    ...
                    <div v-else class="w-auto">
                        <div class="card">
                            <DataTable :value="products">
                                ...
                                <Column field="quantity" header="Number">
                                    <template #body>
                                        <Skeleton class="py-4"></Skeleton>
                                    </template>
                                </Column>

                                <Column field="quantity" header="Capicity">
                                    <template #body>
                                        <Skeleton class="py-4"></Skeleton>
                                    </template>
                                </Column>
    ...
    <!-- Edit room -->
    <template>
        <TransitionRoot as="template" :show="appStore.showStatus">
            <Dialog
                as="div"
                class="relative z-10"
...
const { store, errors, deleteRoom, updateRoom } = useRoom();
...
onBeforeMount(() => {
    if (page != "rooms") {
        localStorage.setItem("pageName", JSON.stringify("rooms"));
