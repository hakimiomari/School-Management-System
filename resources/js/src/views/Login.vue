    ...
    <div class="flex items-center justify-center h-screen px-6 bg-gray-200">
        <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
            <div class="flex items-center justify-center">
                ...
                <span class="text-2xl font-semibold text-gray-700">SMS</span>
            </div>
            <form class="mt-4" @submit.prevent="login(form)">
                <label class="block">
                    ...
                    <input
                        v-model="form.email"
                        type="email"
                        class="block py-2 px-2 border-2 outline-none w-full mt-1 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
                    />
