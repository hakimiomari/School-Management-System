                                        ...
                                        <button
                                            ...
                                            :class="
                                                loading
                                                    ...
                                                    : ''
                                            "
                                            class="text-white bg-indigo-500  focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-500  dark:focus:ring-indigo-800"
                                            v-if="loading"
                                        >
