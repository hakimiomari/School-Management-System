    ...
    <div>
        ...
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                ...
                <div
                    v-else
                    class="flex mx-6 justify-center items-center flex-wrap gap-6"
                >
                    <div class="card">
                        <div class="profile_thumb"></div>
                        <div>
                            <h1 class="post_title mb-3"></h1>
                ...
                >
                    ...
                    >
                        ...
                        <div class="mx-5">
                            ...
                            <div class="text-gray-500">Total Remain</div>
                        </div>
                    </div>
                </div>
                <div
            ...
            <div class="flex flex-col -mx-6 mt-8">
                <h3 class="text-2xl mx-6 font-medium text-gray-700">
                    Today's Attendance
                </h3>
                <div class="flex flex-wrap mt-4">
                    ...
                    >
                        ...
                        >
                            <div
                                class="p-3 bg-green-600 bg-opacity-75 rounded-full"
                            >
                                <svg
                                    class="w-8 h-8 text-white"
                                    viewBox="0 0 28 30"
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="mx-5">
                                ...
                                <div class="text-gray-500">Obsent Students</div>
                            </div>
                        </div>
                    </div>
                    <div
